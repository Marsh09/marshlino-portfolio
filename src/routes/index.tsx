...
const LINKEDIN = "https://www.linkedin.com/in/marshlino-nader/";
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center justify-center gap-2 rounded-md border border-border bg-background/50 px-6 py-3.5 font-mono text-sm font-medium text-foreground transition-colors hover:border-signal/40 hover:bg-accent"
              >
